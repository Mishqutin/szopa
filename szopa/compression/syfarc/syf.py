...
def syf(filefrom, fileto, chunkSize, numberSize):
    ...
    archive_data = {"dict_size": 0, "bytes_over": 0, "chunk_size": chunkSize, "number_size": numberSize}
...
def unsyf(filefrom, fileto):
    ...
    chunkSize = archive_data["chunk_size"]
    numberSize = archive_data["number_size"]
